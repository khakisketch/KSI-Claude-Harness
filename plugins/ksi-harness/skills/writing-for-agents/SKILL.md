...
description: 스킬·AGENTS.md·CLAUDE.md처럼 에이전트가 읽는 문서를 쓰거나 고칠 때 참고하는 레퍼런스(no-op 문장 판별·context load vs cognitive load·leading word 등).
disable-model-invocation: true
---

> 출처: [mattpocock/skills](https://github.com/mattpocock/skills) `productivity/writing-for-agents`(MIT License, Copyright (c) 2026 Matt Pocock). 원문 그대로 보존 — 우리 지침 감량 작업에서 감으로 하던 판단에 이름과 테스트를 붙여준다.
