...
msg = (
    ...
    "**신규 화면·route · 기존 화면의 대규모 레이아웃 변경 · 정보구조 변경 · 주요 동선 변경**이면 "
    "**골격·대표 데이터·최소 렌더 확인까지만** 하고, 방향을 확인받기 전에 전체 동작·세부 polish로 "
    "넘어가지 마세요. 문구·색상·간격 같은 작은 수정이면 이 넛지는 무시하고 계속 진행하세요."
)
