...
원본은 1인 개발자의 개인 `~/.claude` 하네스입니다. 이 repo는 재사용 가능한 골격만 추출한 것으로 개인 메모리와 비밀은 빠져 있습니다.
...
한국 건설현장의 안전모 색 관행을 그대로 씁니다. 파란색은 신입 조사, 노란색은 시공, 흰색은 감리입니다.
...
> 조사원이 찾고, 작업자가 짓고, 감리가 검측합니다. 도면과 다르면 재시공입니다.
> 만든 사람이 스스로 통과시키지 못한다는 것이 이 하네스의 핵심입니다.
...
<div align="center">
<sub>AI에게 오래 맡기려면, 결과를 믿을 수 있어야 합니다.</sub>
</div>
